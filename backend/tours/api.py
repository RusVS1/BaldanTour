        ...
        results = [
            {
                ...
                "meta": {
                    "townfrom": (t.townfrom_ru or "").strip() or _label_from_value(t.townfrom or "", TOWNFROM_SLUG_TO_RU),
                    "country_slug": (t.country_ru or "").strip() or _label_from_value(t.country_slug or "", COUNTRY_SLUG_TO_RU),
